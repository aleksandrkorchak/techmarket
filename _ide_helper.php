 ...
 * Generated for Laravel 5.8.8 on 2019-05-05 14:44:44.
 *
...
namespace Dan\UploadImage { 
    ...
    class UploadImageFacade {
         ...
         * @static 
         */ 
        public static function upload($file, $contentName, $watermark = false, $video = false, $thumbnails = false, $size = false)
        {
                        /** @var \Dan\UploadImage\UploadImage $instance */
                        return $instance->upload($file, $contentName, $watermark, $video, $thumbnails, $size);
        }
         ...
         * @static 
         */ 
        public static function saveLinkImage($file, $contentName)
        {
                        /** @var \Dan\UploadImage\UploadImage $instance */
                        return $instance->saveLinkImage($file, $contentName);
        }
         ...
         * @static 
         */ 
        public static function delete($imageName, $contentName)
        {
                        /** @var \Dan\UploadImage\UploadImage $instance */
                        return $instance->delete($imageName, $contentName);
        }
         ...
         * @static 
         */ 
        public static function deleteBody($textBody)
        {
                        /** @var \Dan\UploadImage\UploadImage $instance */
                        return $instance->deleteBody($textBody);
        }
         ...
         * @static 
         */ 
        public static function load($contentName, $size = null)
        {
                        /** @var \Dan\UploadImage\UploadImage $instance */
                        return $instance->load($contentName, $size);
        }
        ...
        {
                        return \Dan\UploadImage\UploadImage::convertToBase64($image_path_file);
        }
         ...
         * @static 
         */ 
        public static function preview($file, $contentName)
        {
                        /** @var \Dan\UploadImage\UploadImage $instance */
                        return $instance->preview($file, $contentName);
        }
         ...
         * @static 
         */ 
        public static function getImagesFromBody($html)
        {
                        /** @var \Dan\UploadImage\UploadImage $instance */
                        return $instance->getImagesFromBody($html);
        }
         ...
         * @static 
         */ 
        public static function saveFileToDisk($file, $contentName)
        {
                        /** @var \Dan\UploadImage\UploadImage $instance */
                        return $instance->saveFileToDisk($file, $contentName);
        }
         ...
         * @static 
         */ 
        public static function generateNewName($contentName, $ext)
        {
                        /** @var \Dan\UploadImage\UploadImage $instance */
                        return $instance->generateNewName($contentName, $ext);
        }
         ...
         * @static 
         */ 
        public static function createWatermarkArray($watermark, $video)
        {
                        /** @var \Dan\UploadImage\UploadImage $instance */
                        return $instance->createWatermarkArray($watermark, $video);
        }
         ...
         * @static 
         */ 
        public static function resizeImageAddWatermark($originalPath, $watermark_array)
        {
                        /** @var \Dan\UploadImage\UploadImage $instance */
                        return $instance->resizeImageAddWatermark($originalPath, $watermark_array);
        }
         ...
         * @static 
         */ 
        public static function createThumbnails($imagePath, $originalPath, $newName)
        {
                        /** @var \Dan\UploadImage\UploadImage $instance */
                        return $instance->createThumbnails($imagePath, $originalPath, $newName);
        }
         ...
         * @static 
         */ 
        public static function deleteThumbnails($imagePath, $imageName)
        {
                        /** @var \Dan\UploadImage\UploadImage $instance */
                        return $instance->deleteThumbnails($imagePath, $imageName);
        }
...
namespace  { 
    ...
    class UploadImage extends \Dan\UploadImage\UploadImageFacade {}
