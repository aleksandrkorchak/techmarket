    ...
    <div class="row">
        ...
        <div id="products" class="col-lg-8 col-md-8 col-sm-8 col-xs-12 message">
            <div class="row block-top">
                ...
                <div class="nav-btn">
                    <a href="{{ route('show.users.notifications') }}" class="active-navbtn">Пользователи <span>1</span></a>
                    <a href="{{ route('show.searches.notifications') }}">Заявки</a>
                </div>
                ...
                <table class="table">
                    ...
                    @foreach($notifications->getCollection() as $notification)
                        <tr @empty($notification['read_at']) class="new" @endempty>
                            ...
                            <td>
                                <p>{{ $notification['data']['text'] . ' "' . $notification['data']['user_login'] . '"' }}</p>
                            </td>
                            <td class="text-right">
                                <em>{{ new Carbon\Carbon($notification['data']['user_created_at']) }}</em></td>
                        </tr>
                    @endforeach
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu" role="menu" style="min-width: 0px ">
                            <li
                                    ...
                                    class="active"
                                    @endif>
                                <a href="{{ route('show.users.notifications') . '?size=5' }}">5</a></li>
                            <li
                                    @if($notifications->perPage() == 10)
                                    class="active"
                                    @endif>
                                <a href="{{ route('show.users.notifications') . '?size=10' }}">10</a>
                            </li>
                            <li
                                    @if($notifications->perPage() == 15)
                                    class="active"
                                    @endif>
                                <a href="{{ route('show.users.notifications') . '?size=15' }}">15</a></li>
                            <li
                                    @if($notifications->perPage() == 20)
                                    class="active"
                                    @endif>
                                <a href="{{ route('show.users.notifications') . '?size=20' }}">20</a></li>
                        </ul>
                    </div>
                </div>
            </div>
