    ...
    <div class="row">
        ...
        <div id="products" class="col-lg-8 col-md-8 col-sm-8 col-xs-12 message">
            <div class="row block-top">
                ...
                <div class="nav-btn">
                    <a href="{{ route('show.users.notifications') }}">Пользователи <span>1</span></a>
                    <a href="{{ route('show.searches.notifications') }}" class="active-navbtn">Заявки</a>
                </div>
                ...
                <table class="table">
                    ...
                    @foreach($notifications->getCollection() as $notification)
                        <tr @empty($notification['read_at']) class="new" @endempty>
                            ...
                            <td>
                                <p><a href="{{ route('search.id', [$notification['data']['search_id']]) }}">ссылка</a></p>
                            </td>
                            <td class="text-right">
                                <em>{{ $notification['data']['search_created_at'] }}</em></td>
                        </tr>
                    @endforeach
