...
@section('main')
    <div class="row">
        <!--------------------- admin-profile----------->
        <h1>Пользователи <span>(1)</span></h1>
        <div id="products" class="col-lg-8 col-md-8 col-sm-8 col-xs-12 users">
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td><a href="{{ route('show.profile', ['user_id' => $user->id]) }}">{{ $user['login'] }}</a></td>
                                <td>
                                    {{ $user['phone'] }}
                                </td>
